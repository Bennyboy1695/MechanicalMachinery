...
public class MechanicalMachineryJEI implements IModPlugin {

    private static final ResourceLocation ID = MechanicalMachinery.rl("jei_plugin");
    ...
    private void loadCategories() {
        ...
        CreateRecipeCategory<SifterRecipe>
                ...
                .emptyBackground(177, 135)
                .build("sifter", SifterCategory::new);
    }
