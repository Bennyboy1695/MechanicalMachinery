...
public class MechanicalSiftingJEI implements IModPlugin {

    private static final ResourceLocation ID = MechanicalSifting.rl("jei_plugin");
    ...
    private class CategoryBuilder<T extends Recipe<?>> {
        ...
        public CreateRecipeCategory<T> build(String name, CreateRecipeCategory.Factory<T> factory) {
            ...
            CreateRecipeCategory.Info<T> info = new CreateRecipeCategory.Info<>(
                    new mezz.jei.api.recipe.RecipeType<>(MechanicalSifting.rl(name), recipeClass),
