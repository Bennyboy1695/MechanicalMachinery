package io.github.bennyboy1695.mechanicalsifting.integration.jei;
...
import io.github.bennyboy1695.mechanicalsifting.register.ModGUITextures;
...
*/
        ...
        if (results.size() > 47) {
            MechanicalSifting.getLogger().warn("Recipe({}) is larger than 47 items output. This means its not going to render well", recipe.getId().toString());
        }
